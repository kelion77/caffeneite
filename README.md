...
This installs `CaffBar.spoon`, enables Hammerspoon launch at login, writes an idempotent startup block, and starts CaffBar in Smart Awake mode (`smart`). Toggle with `Shift+Cmd+K`.
